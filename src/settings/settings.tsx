...
export const Settings: React.FC<RouteComponentProps> = () => {
  ...
  const handleSubmit = (e: FormEvent) => {
    e.preventDefault();
    authHttp
      .post('api/settings', settingsData)
      .then(() => {
        enqueueSnackbar('Saved successfully.', { autoHideDuration: 3000 });
      })
      .catch(() => {
        enqueueSnackbar('Error. Failed to save settings.', {
      ...
      <form className={classes.form} onSubmit={handleSubmit}>
        <div className="personalSettings">
          ...
          <TextField
            ...
            onChange={onChange}
            value={
              (settingsData.personal && settingsData.personal.personalOib) || ''
            }
          />
          <TextField
            name="streetName"
        ...
        <div className="companySettings">
          ...
          <TextField
            ...
            onChange={onChange}
            value={
              (settingsData.company && settingsData.company.companyOib) || ''
            }
          />
          <TextField
            name="companyEmail"
        ...
        <div className="salarySettings">
          ...
          <TextField
            ...
            onChange={onChange}
            value={
              (settingsData.salary && settingsData.salary.nonTaxableAmount) ||
              ''
            }
          />
          <TextField
          ...
          <div>
            ...
            <TextField
              ...
              value={
                (settingsData.salary &&
                  settingsData.salary.healthInsuranceContribution) ||
                ''
              }
            />
            <TextField
              ...
              value={
                (settingsData.salary &&
                  settingsData.salary.workSafetyContribution) ||
                ''
              }
            />
            <TextField
              ...
              value={
                (settingsData.salary &&
                  settingsData.salary.employmentContribution) ||
                ''
              }
            />
            <TextField
              ...
              value={
                (settingsData.salary &&
                  settingsData.salary.pensionPillar1Contribution) ||
                ''
              }
            />
            <TextField
              ...
              value={
                (settingsData.salary &&
                  settingsData.salary.pensionPillar2Contribution) ||
                ''
              }
            />
          </div>
        ...
        <div className="dividendSettings">
          ...
          <TextField
            ...
            onChange={onChange}
            value={
              (settingsData.dividend && settingsData.dividend.dividendTax) || ''
            }
          />
        </div>
